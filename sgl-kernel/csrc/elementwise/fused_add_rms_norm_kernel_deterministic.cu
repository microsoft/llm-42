#include "vllm/type_convert.cuh"
#include "vllm/dispatch_utils.h"
#include "vllm/cub_helpers.h"
#include "vllm/quantization/vectorization_utils.cuh"
...
void vllm_rmsnorm(torch::Tensor& out,     // [..., hidden_size]
...
void vllm_fused_add_rmsnorm_dynamic(torch::Tensor& input,     // [..., hidden_size]
...
void vllm_fused_add_rmsnorm_1024(torch::Tensor& input,     // [..., hidden_size]
                        torch::Tensor& residual,  // [..., hidden_size]
                        torch::Tensor& weight,    // [hidden_size]
                        double epsilon) {
  TORCH_CHECK(weight.scalar_type() == input.scalar_type());
