...
INPUT_DIR="etalon_results_component_tests"
OUTPUT_DIR=""
...
if [ -n "$OUTPUT_DIR" ]; then
    $PYTHON_CMD plot_component_results.py --input-dir "$INPUT_DIR" --output-dir "$OUTPUT_DIR"
else
    $PYTHON_CMD plot_component_results.py --input-dir "$INPUT_DIR"
fi
