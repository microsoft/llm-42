...
class DetokenizerManager(MultiHttpWorkerDetokenizerMixin):
    ...
    def handle_batch_token_id_out(self, recv_obj: BatchTokenIDOutput):
        ...
        return BatchStrOutput(
            ...
            llm42_num_rollbacks=recv_obj.llm42_num_rollbacks,
            llm42_tokens_rolled_back=recv_obj.llm42_tokens_rolled_back,
            llm42_num_verification_windows=recv_obj.llm42_num_verification_windows,
