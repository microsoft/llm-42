...
class SamplingBatchInfo:
    ...
    def from_schedule_batch(cls, batch: ScheduleBatch, vocab_size: int):
        ...
        enable_deterministic = global_server_args_dict["enable_deterministic_inference"] > 0 or global_server_args_dict["enable_llm_42"] > 0 or global_server_args_dict["enable_selective_determinism"] > 0
