...
echo "QPS: $QPS"
echo ""
echo "This will run 3 traces × 4 percentages × 4 modes = 48 total tests"
echo "================================================"
echo ""
...
for trace in "${TRACES[@]}"; do
    ...
    case $trace in
        arxiv)
            echo "  - llama-3.1-8b_arxiv_summarization_pct_${TEMP0_PCTS//,/_}/"
            ;;
        sharegpt)
            echo "  - llama-3.1-8b_sharegpt_8k_pct_${TEMP0_PCTS//,/_}/"
            ;;
        lmsys)
            echo "  - llama-3.1-8b_lmsys_chat_1m_conversation_pct_${TEMP0_PCTS//,/_}/"
            ;;
    esac
done
echo ""
