...
TEMP0_PCTS=""  # Default: 10% of requests have temperature=0 (comma-separated list)
...
FIXED_MODE_DESCRIPTIONS=(
    "Mode 2 (batch-invariant: native-rmsnorm + cutlass)"
...
total_tests=$((${#FIXED_MODES[@]} + ${#PCT_ARRAY[@]}))
