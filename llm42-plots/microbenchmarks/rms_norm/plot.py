...
def plot_one(results, batch_sizes, hidden_size, lines, all_batch_sizes, titles=None, output_dir=".", file_name="rmsnorm_benchmark_one.png"):
    ...
    colors = ['tab:green', 'tab:red', 'tab:gray', 'tab:orange', 'tab:purple', 'tab:brown', 'tab:pink', 'tab:blue', 'tab:olive', 'tab:cyan']
    markers = ['o', 's', '^', 'D', 'v', 'P', '*', 'X', 'h', '8']
    ...
    ax_time.legend(fontsize=20, loc='best', frameon=True)
...
plot_one(results, filtered_batch_sizes, 8192,
         ...
         output_dir="./plots/", file_name="rmsnorm_impl.pdf")