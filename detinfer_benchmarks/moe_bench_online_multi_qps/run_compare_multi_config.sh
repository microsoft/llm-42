...
NUM_PROMPTS_ARRAY=${NUM_PROMPTS_ARRAY:-"999,9999"}
...
BASE_OUTPUT_DIR=${OUTPUT_DIR:-"${ROOT}/tp2_llama_fa3_stream_global_t0_${TIMESTAMP}_n${NUM_PROMPTS_ARRAY}"}
