...
if [[ -z "${CONFIGS:-}" ]]; then
    NUM_CONFIGS_TO_GENERATE=${NUM_CONFIGS_TO_GENERATE:-12}
    QPS_START=${QPS_START:-9.0}
...
NUM_PROMPTS_ARRAY=${NUM_PROMPTS_ARRAY:-"92812"}
...
BASE_OUTPUT_DIR=${OUTPUT_DIR:-"${ROOT}/fi_stream_di3_s32_bs16_t0_${TIMESTAMP}"}
