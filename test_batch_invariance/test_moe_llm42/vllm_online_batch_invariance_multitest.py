...
def test_multi_batch_invariance(
    ...
    min_prompt_words = int(os.getenv("SGLANG_MIN_PROMPT_WORDS", "480"))
    max_prompt_words = int(os.getenv("SGLANG_MAX_PROMPT_WORDS", "480"))
...
if __name__ == "__main__":
    ...
    batch_sizes = [i for i in range(3, 128, 23)]
    max_tokens_list = [1, 8, 16, 133, 326, 689]
    
    # Configure prompt length (words)
    min_prompt_words = int(os.getenv("SGLANG_MIN_PROMPT_WORDS", "4800"))
    max_prompt_words = int(os.getenv("SGLANG_MAX_PROMPT_WORDS", "5100"))
