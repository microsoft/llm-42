...
attn_configs = {
    ...
    #'llama-8b-tp1': {'num_heads': 32, 'num_kv_heads': 8, 'head_dim': 128},
    'llama-8b-tp2': {'num_heads': 16, 'num_kv_heads': 4, 'head_dim': 128},
    #'llama-8b-tp4': {'num_heads': 8, 'num_kv_heads': 2, 'head_dim': 128},
